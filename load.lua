...
GUI_NAME = random_string()
FOLDER_NAME = random_string()
island_esp_enabled = true

function create_parts()
    local Town_of_Beginnings = Instance.new("Part", game.workspace[FOLDER_NAME])
    Town_of_Beginnings.CFrame = ISLANDS.Town_of_Beginnings
    Town_of_Beginnings.Name = "Town of Beginnings"
    Town_of_Beginnings.Transparency = 1
    Town_of_Beginnings.Anchored = true

    local Marine_Fort_F1 = Instance.new("Part", game.workspace[FOLDER_NAME])
    Marine_Fort_F1.CFrame = ISLANDS.Marine_Fort_F1
    Marine_Fort_F1.Name = "Marine Fort F1"
    Marine_Fort_F1.Transparency = 1
    Marine_Fort_F1.Anchored = true

    local Sandora = Instance.new("Part", game.workspace[FOLDER_NAME])
    Sandora.CFrame = ISLANDS.Sandora
    Sandora.Name = "Sandora"
    Sandora.Transparency = 1
    Sandora.Anchored = true

    local Roca_Island = Instance.new("Part", game.workspace[FOLDER_NAME])
    Roca_Island.CFrame = ISLANDS.Roca_Island
    Roca_Island.Name = "Roca Island"
    Roca_Island.Transparency = 1
    Roca_Island.Anchored = true

    local Land_Of_The_Sky = Instance.new("Part", game.workspace[FOLDER_NAME])
    Land_Of_The_Sky.CFrame = ISLANDS.Land_Of_The_Sky
    Land_Of_The_Sky.Name = "Land Of The Sky"
    Land_Of_The_Sky.Transparency = 1
    Land_Of_The_Sky.Anchored = true

    local Fishman_Island = Instance.new("Part", game.workspace[FOLDER_NAME])
    Fishman_Island.CFrame = ISLANDS.Fishman_Island
    Fishman_Island.Name = "Fishman Island"
    Fishman_Island.Transparency = 1
    Fishman_Island.Anchored = true

    local Fishman_Cave = Instance.new("Part", game.workspace[FOLDER_NAME])
    Fishman_Cave.CFrame = ISLANDS.Fishman_Cave
    Fishman_Cave.Name = "Fishman Cave"
    Fishman_Cave.Transparency = 1
    Fishman_Cave.Anchored = true

    local Mysterious_Cliff = Instance.new("Part", game.workspace[FOLDER_NAME])
    Mysterious_Cliff.CFrame = ISLANDS.Mysterious_Cliff
    Mysterious_Cliff.Name = "Mysterious Cliff"
    Mysterious_Cliff.Transparency = 1
    Mysterious_Cliff.Anchored = true

    local Gravito_Fort = Instance.new("Part", game.workspace[FOLDER_NAME])
    Gravito_Fort.CFrame = ISLANDS.Gravito_Fort
    Gravito_Fort.Name = "Gravito Fort"
    Gravito_Fort.Transparency = 1
    Gravito_Fort.Anchored = true

    local Shark_Park = Instance.new("Part", game.workspace[FOLDER_NAME])
    Shark_Park.CFrame = ISLANDS.Shark_Park
    Shark_Park.Name = "Shark Park"
    Shark_Park.Transparency = 1
    Shark_Park.Anchored = true

    local Colosseum = Instance.new("Part", game.workspace[FOLDER_NAME])
    Colosseum.CFrame = ISLANDS.Colosseum
    Colosseum.Name = "Colosseum"
    Colosseum.Transparency = 1
    Colosseum.Anchored = true

    local Coco_Island = Instance.new("Part", game.workspace[FOLDER_NAME])
    Coco_Island.CFrame = ISLANDS.Coco_Island
    Coco_Island.Name = "Coco Island"
    Coco_Island.Transparency = 1
    Coco_Island.Anchored = true

    local Restaurant_Baratie = Instance.new("Part", game.workspace[FOLDER_NAME])
    Restaurant_Baratie.CFrame = ISLANDS.Restaurant_Baratie
    Restaurant_Baratie.Name = "Restaurant Baratie"
    Restaurant_Baratie.Transparency = 1
    Restaurant_Baratie.Anchored = true

    local Island_Of_Zou = Instance.new("Part", game.workspace[FOLDER_NAME])
    Island_Of_Zou.CFrame = ISLANDS.Island_Of_Zou
    Island_Of_Zou.Name = "Island Of Zou"
    Island_Of_Zou.Transparency = 1
    Island_Of_Zou.Anchored = true

    local Reverse_Mountain = Instance.new("Part", game.workspace[FOLDER_NAME])
    Reverse_Mountain.CFrame = ISLANDS.Reverse_Mountain
    Reverse_Mountain.Name = "Reverse Mountain"
    Reverse_Mountain.Transparency = 1
    Reverse_Mountain.Anchored = true

    local Kori_Island = Instance.new("Part", game.workspace[FOLDER_NAME])
    Kori_Island.CFrame = ISLANDS.Kori_Island
    Kori_Island.Name = "Kori Island"
    Kori_Island.Transparency = 1
    Kori_Island.Anchored = true

    local Sphinx_Island = Instance.new("Part", game.workspace[FOLDER_NAME])
    Sphinx_Island.CFrame = ISLANDS.Sphinx_Island
    Sphinx_Island.Name = "Sphinx Island"
    Sphinx_Island.Transparency = 1
    Sphinx_Island.Anchored = true

    local Marine_Base_G1 = Instance.new("Part", game.workspace[FOLDER_NAME])
    Marine_Base_G1.CFrame = ISLANDS.Marine_Base_G1
    Marine_Base_G1.Name = "Marine Base G-1"
    Marine_Base_G1.Transparency = 1
    Marine_Base_G1.Anchored = true

    local Orange_Town = Instance.new("Part", game.workspace[FOLDER_NAME])
    Orange_Town.CFrame = ISLANDS.Orange_Town
    Orange_Town.Name = "Orange Town"
    Orange_Town.Transparency = 1
    Orange_Town.Anchored = true

    local Shell_Town = Instance.new("Part", game.workspace[FOLDER_NAME])
    Shell_Town.CFrame = ISLANDS.Shell_Town
...
function delete_parts()
    for i,v in pairs (game:GetService("workspace")[FOLDER_NAME]:GetDescendants()) do
        v:Destroy()
    end
end
